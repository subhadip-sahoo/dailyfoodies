                                ...
                                <article class="timeline-item  standard-post  clearfix">
                                        ...
                                        <div class="kp-thumb hover-effect">
                                            <p>
                                                ...
                                                <input type="url" placeholder="Please enter your Facebook URL" name="facebook" id="facebook" class="reg_txt_fldt" value="<?php if(isset($facebook)){echo $facebook;}else{echo $current_user->facebook;}?>" />
                                            </p>
                                        </div>
                                </article><!--timeline-item-->
                                <article class="timeline-item  standard-post  clearfix">
                                        ...
                                        <div class="kp-thumb hover-effect">
                                            <p>
                                                <label>Twitter</label>
                                                <input type="url" placeholder="Please enter your Twitter URL" name="twitter" id="twitter" class="reg_txt_fldt" value="<?php if(isset($twitter)){echo $twitter;}else{echo $current_user->twitter;}?>" />
                                            </p>
                                        </div>
                                </article><!--timeline-item-->
                                <article class="timeline-item  standard-post  clearfix">
                                        ...
                                        <div class="kp-thumb hover-effect">
                                           <p>
                                                ...
                                                <input type="url" placeholder="Please enter your Pinterest URL" name="pinterest" id="pinterest" class="reg_txt_fldt" value="<?php if(isset($pinterest)){echo $pinterest;}else{echo $current_user->pinterest;}?>" />
                                            </p>
                                        </div>
                                </article><!--timeline-item-->
                                <article class="timeline-item  standard-post  clearfix">
