				...
				<?php if( ! $user_ID ) : ?>
					<div class="section-container">
						...
						<div id="login" class="wpml-content">
							...
							<h2><?php _e( 'PLEASE LOGIN', 'geissinger-wpml' ); ?></h2>
...
<!--									<label class="field-titles" for="login_user"><?php //_e( 'Username', 'geissinger-wpml' ); ?></label>-->
									<input type="text" name="log" id="login_user" placeholder="Username" class="popup_txtfld" value="<?php if ( isset( $user_login ) ) echo esc_attr( $user_login ); ?>" size="20" />
								</p>
                                                            </div>
                                                            <div class="pup_pass">
								<p>
									<!--<label class="field-titles" for="login_pass"><?php// _e( 'Password', 'geissinger-wpml' ); ?></label>-->
									<input type="password" name="pwd" id="login_pass" placeholder="Password" class="popup_txtfld" value="" size="20" />
								</p>
                                                            </div>
								<?php do_action( 'login_form' ); ?>
                                                            <div class="test">
                                                                <div class="pup_ck_on">
								<span id="forgetmenot">
									<input name="rememberme" type="checkbox" id="rememberme" value="forever" class="pup_cheak_box" />
                                                                        <div class="pup_ck_off"><img src="<?php echo plugins_url();?>/wp-modal-login/images/icons/pup_ck_off.png"></div>
                                                                </span>
                                                            </div>
                                                            </div>
                                                            <div class="pup_re"><p>Remember me</p><a href="#forgotten" class="wpml-nav">Forgot password</a></div>
                                                            <div class="pop_btn_bg_div">	
                                                            <p class="submit">

									<?php do_action( 'inside_wpml_login_submit' ); ?>

									<input type="submit" name="wp-sumbit" id="wp-submit" class="button button-primary button-large pop_btn" value="<?php _e( 'LOGIN', 'geissinger-wpml' ); ?>" />
						...
						<div id="forgotten" class="wpml-content" style="display:none;">
							...
							<form action="forgotten" method="post" id="form" class="group" name="loginform">
								...
								<p>
									...
									<input type="text" name="forgot_login" id="forgot_login" placeholder="Username/Email" class="popup_txtfld"  value="<?php if ( isset( $user_login ) ) echo esc_attr( stripslashes( $user_login ) ); ?>" size="20" />
								</p>
                                                            </div>
								...
								<p class="submit">
									...
									<input type="submit" name="user-submit" id="user-submit" class="button button-primary button-large pop_btn" value="<?php esc_attr_e( 'Reset Password', 'geissinger-wpml' ); ?>">
