...
/*===============================================================
 * Load more custom dailyfoodies
 ===============================================================*/
function loadmore_articles_custom_df(obj) {
    jQuery(".kp-loading").removeClass("hidden");
    kopa_post_id_string = jQuery("#post_id_array").val();
    kopa_categories_arg = jQuery(".df_cat_name").val();
//    alert(kopa_categories_arg);
//    jQuery(".df_cat_name").each(function() {
//        if (jQuery(this).val() != 'none') {
//            kopa_categories_arg.push(jQuery(this).val());
//        }
//    });
...
//    kopa_orderbye_arg = jQuery("#kopa_orderbye_arg").val();
    ...
    if (jQuery("#no_post_found").val() == '0') {
        jQuery.ajax({
            ...
            dataType: 'html',
            data: {
                action: "load_more_articles_custom_df",
                kopa_post_id_string: kopa_post_id_string,
                kopa_categories_arg: kopa_categories_arg,
//                count: count,
//                count_new: count_new,
...
//                kopa_orderbye_arg: kopa_orderbye_arg,
                stored_month_year: stored_month_year,
                wpnonce: jQuery('#nonce_id_load_more_custom_df').val()
            },
            beforeSend: function() {
...
//            alert(data);
//                console.log(data);
                //alert(jQuery("#posts_not_in").val());
                //post_id_array_new = jQuery("#posts_not_in").val();
                jQuery("#post_id_array").remove();
