...
//        echo '<pre>';
//        print_r($instance['title_1']);
//        echo '</pre>';
//        echo '<pre>';
//        print_r($instance['display_type_1']);
//        echo '</pre>';
//        echo '<pre>';
//        print_r($instance['categories_1']);
//        echo '</pre>';
//        echo '<pre>';
//        print_r($instance['relation_1']);
//        echo '</pre>';
//        echo '<pre>';
//        print_r($instance['tags_1']);
//        echo '</pre>';
//        echo '<pre>';
//        print_r($instance['number_of_article_1']);
//        echo '</pre>';
//        echo '<pre>';
//        print_r($instance['orderby_1']);
//        echo '</pre>';
        $title_class = '';
        $tab_content_class = '';
                    ...
                    while ($services->have_posts()):
                        ...
                        <div class="span3">
                            <article>
                                <div class="ch-item">
                                    <div class="ch-info">
                <?php if (!empty($service_custom_icon_src)) : ?>
